...
class CalculaMedia: NSObject {
    
    func calculaMediaGeral(alunos:Array<Aluno>, sucesso: @escaping(_ dicionarioDeMedias:Dictionary<String, Any>)->Void, falha: @escaping(_ error: Error)-> Void){
